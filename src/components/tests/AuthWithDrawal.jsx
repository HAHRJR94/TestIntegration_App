...
const AuthWithDrawal = () => {
  ...
  useEffect(() => {
    ...
    const consultarAPI = async () => {
      if(request){
        await fetch('http://bankapimaai.azurewebsites.net/api/WithDrawal', {
        method: 'POST',
        ...
        .catch(error => {
          console.log(error)
          setDataComponent({
            title: 'Auth & WithDrawal Integration',
  ...
  return (
    <div className='container vh-100'>
      <h1 className='text-primary text-center mt-4'>Auth & WithDrawal Test</h1>
